...
BEGIN {
  $Cassandra::Cassandra_login_args::VERSION = '0.0.6';
}
...
BEGIN {
  $Cassandra::Cassandra_login_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_set_keyspace_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_set_keyspace_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_get_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_get_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_get_slice_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_get_slice_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_get_count_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_get_count_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_multiget_slice_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_multiget_slice_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_multiget_count_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_multiget_count_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_get_range_slices_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_get_range_slices_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_get_indexed_slices_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_get_indexed_slices_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_insert_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_insert_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_add_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_add_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_remove_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_remove_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_remove_counter_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_remove_counter_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_batch_mutate_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_batch_mutate_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_truncate_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_truncate_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_schema_versions_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_schema_versions_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_keyspaces_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_keyspaces_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_cluster_name_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_cluster_name_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_version_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_version_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_ring_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_ring_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_partitioner_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_partitioner_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_snitch_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_snitch_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_keyspace_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_keyspace_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_splits_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_describe_splits_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_system_add_column_family_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_system_add_column_family_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_system_drop_column_family_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_system_drop_column_family_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_system_add_keyspace_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_system_add_keyspace_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_system_drop_keyspace_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_system_drop_keyspace_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_system_update_keyspace_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_system_update_keyspace_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_system_update_column_family_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_system_update_column_family_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_execute_cql_query_args::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::Cassandra_execute_cql_query_result::VERSION = '0.0.6';
}
use base qw(Class::Accessor);
...
BEGIN {
  $Cassandra::CassandraIf::VERSION = '0.0.6';
}
...
BEGIN {
  $Cassandra::CassandraRest::VERSION = '0.0.6';
}
...
BEGIN {
  $Cassandra::CassandraClient::VERSION = '0.0.6';
}
...
BEGIN {
  $Cassandra::CassandraProcessor::VERSION = '0.0.6';
}
